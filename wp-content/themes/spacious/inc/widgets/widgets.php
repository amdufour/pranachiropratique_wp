...
function spacious_widgets_init() {
	...
	// Registering Business Page template top-second section sidebar
	register_sidebar( array(
		'name' 				=> esc_html__( 'Business Top-second Sidebar', 'spacious' ),
		'id' 					=> 'spacious_business_page_top_second_section_sidebar',
		'description'   	=> esc_html__( 'Shows widgets on Business Page Template Top-second Section.', 'spacious' ).' '.__( 'Suitable widget: TG: Services, TG: Call To Action Widget, TG: Featured Widget', 'spacious' ),
		'before_widget' 	=> '<section id="%1$s" class="widget %2$s clearfix">',
		'after_widget'  	=> '</section>',
		'before_title'  	=> '<h3 class="widget-title">',
		'after_title'   	=> '</h3>'
	...
	// Registering Business Page template middle section full-width
	register_sidebar( array(
		'name' 				=> esc_html__( 'Business Middle full-width', 'spacious' ),
		'id' 					=> 'spacious_business_page_middle_section_full_width',
		'description'   	=> esc_html__( 'Shows widgets on Business Page Template Middle Section Full Width.', 'spacious' ).' '.__( 'Suitable widget: TG: Testimonial, TG: Featured Single Page', 'spacious' ),
		'before_widget' 	=> '<section id="%1$s" class="widget %2$s clearfix">',
		'after_widget'  	=> '</section>',
		'before_title'  	=> '<h3 class="widget-title">',
		'after_title'   	=> '</h3>'
