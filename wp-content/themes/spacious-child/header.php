 ...
 *
 * Displays all of the <head> section and everything up till <div id="main" class="clearfix"> <div class="container">
 *
 * @package ThemeGrill
 * @subpackage Spacious
 * @since Spacious 1.0
		...
		<div id="header-text-nav-container">
			<div class="container">
				...
				<div class="header-brand">
					...
					?>
					<div class="header-text" class="<?php echo $screen_reader; ?>">
				...
				<div class="header-text-nav-wrap" class="clearfix">
					<?php
					...
					?>
					<nav class="site-navigation" class="main-navigation" role="navigation">
